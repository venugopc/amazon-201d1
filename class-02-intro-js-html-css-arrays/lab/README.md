...
- Note that as we progress through the first course module, new user stories will be added to the "About Me" project to guide the development of new features.
